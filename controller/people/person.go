...
func (a *personEndpoint) List(w http.ResponseWriter, r *http.Request) {
	var res Response
...
func (a *personEndpoint) Show(w http.ResponseWriter, r *http.Request) {
	var res Response
...
func (a *personEndpoint) Delete(w http.ResponseWriter, r *http.Request) {
	var res Response
...
func (a *personEndpoint) Create(w http.ResponseWriter, r *http.Request) {
	var res Response
	var p model.Person
...
func (a *personEndpoint) Update(w http.ResponseWriter, r *http.Request) {
	var res Response
	var p model.Person
